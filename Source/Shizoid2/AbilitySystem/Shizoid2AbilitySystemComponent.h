...
#include "Shizoid2AbilitySystemComponent.generated.h"

class UAbilityAnimNotify;
class USkeletalMeshComponent;
class UAnimSequenceBase;
class UShizoid2AbilityAttributeSet;
class UDataTable;
class APawn;
class AController;

USTRUCT()
struct FShizoid2AttributeApplication
{
	GENERATED_BODY()

	// Ability set to grant
	UPROPERTY(EditAnywhere)
	TSubclassOf<UShizoid2AbilityAttributeSet> AttributeSetType;
...
class UShizoid2AbilitySystemComponent : public UAbilitySystemComponent
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = Ability)
	TArray<FShizoid2AttributeApplication> DefaultAttributes;
	...
	UFUNCTION(BlueprintCallable, Category = "Shizoid2|Abilities")
