...
struct FShizoid2AbilityMapping
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FShizoid2AttributesMapping
{
	GENERATED_BODY()

	// Ability set to grant
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TSoftClassPtr<UShizoid2AbilityAttributeSet> AttributeSetType;
...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<FShizoid2AbilityMapping> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<FShizoid2AttributesMapping> GrantedAttributes;
};
